...
%%This module can be moved to the webserver app because 
%%it is not included in the DD app frontend and 
%%it is a part of the web app even if 
%%I did not define the accepted methods and data.
