...
%% The conversion using unicode functions resolve the problem with UTF8 Author Leila Keza
   Doc = [{<<"Date">>, unicode:characters_to_binary(Skapad)}, 
	   {<<"Contract type">>, unicode:characters_to_binary(Kontact,utf8)},
		  	{<<"District">>, unicode:characters_to_binary(
			 lists:append(Region, " / Gothenburg"), utf8)},
				{<<"Rent">>, unicode:characters_to_binary(Hyra, utf8)},
				{<<"Rooms">>, unicode:characters_to_binary(Room, utf8)},
				{<<"Area">>, unicode:characters_to_binary(Boyta, utf8)}],
   
         erlang_couchdb:create_document({"localhost", 5984}, "rent_gbg_bo", Doc). %% End Leilas codes 
